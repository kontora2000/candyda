  export const initAnimation = () => {
    ...
    const circles = [],
    canvas = document.getElementById("bg-circles"),
    context = canvas.getContext("2d"),
    
    opacity = 1,                                      // the opacity of the circles 0 to 1
    colors = ['rgba(255, 0, 0,' + opacity + ')',       // an array of rgb colors for the circles
    'rgba(44, 179, 255,' + opacity + ')'
  ],
  minSize = 100,                                        // the minimum size of the circles in px
  maxSize = 480,                                       // the maximum size of the circles in px
